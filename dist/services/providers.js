...
exports.CITY = "Rotterdam";
exports.MIN_PRICE = 400;
exports.PROVIDERS = {
    rdamapartments: {
        url: `https://rotterdamapartments.com/en/Rental-apartments/filter/${exports.CITY}`,
        filters: {
    ...
    benhousing: {
        url: `https://benhousing.nl/en/properties/filter(price-${exports.MIN_PRICE}%7Eterm-${exports.CITY.toLowerCase()})`,
        filters: {
            item: ".item",
    ...
    huurWoningen: {
        url: `https://www.huurwoningen.nl/in/${exports.CITY.toLowerCase()}/?min_price=${exports.MIN_PRICE}&number_of_rooms=15&size=50&sort=datetime_created&direction=desc&page=1`,
        filters: {
            item: ".listing",
            url: ".listing__link",
    ...
    verrarealestate: {
        url: `https://www.verrarealestate.com/huurwoningen/?for-sale=0&address=&min-price=${exports.MIN_PRICE}&forsale-min-price=&forsale-max-price=&city=${exports.CITY}&district=&interior=&bedrooms=&available_at=&surface=&house_type=&house_type=`,
        filters: {
            item: "li.rent",
    ...
    ideaalhousing: {
        url: `https://www.ideaalhousing.nl/dutch-rent-listings?city=${exports.CITY}&house_type=&min_price=${exports.MIN_PRICE}&range=&surface=&bedrooms=&interior=&location=&available_at_date-datepicker=&available_at_date=`,
        filters: {
    ...
    dopdop: {
        url: `https://www.dop-dop.com/properties?city=${exports.CITY}&bedrooms=&min_price=${exports.MIN_PRICE}&available_at_date=`,
        filters: {
            item: ".listings .listing",
            title: ".address",
            address: ".address",
    ...
    rotterdamrent: {
        url: `https://www.rotterdamrent.com/rental-properties?city=${exports.CITY}&min_price=${exports.MIN_PRICE}&interior=`,
        filters: {
            item: ".listings .listing",
            title: "article h3",
            address: "article h3",
    ...
    OneTwoThreeWonen: {
        url: `https://www.123wonen.nl/huurwoningen/in/${exports.CITY.toLowerCase()}/sort/newest`,
        filters: {
    ...
    perfectrent: {
        url: `https://www.perfectrent.nl/nl/huren/aanbod/rentals?view=&order=added&accommodation%5B%5D=apartment&accommodation%5B%5D=room&priceMin=${exports.MIN_PRICE}&persons=1&order=added&direction=desc&&order=added&direction=desc&`,
        filters: {
            item: ".object",
    ...
    deblooisvastgoed: {
        url: `https://www.deblooisvastgoed.nl/huuraanbod/?filter_city=${exports.CITY}&filter_min_price=${exports.MIN_PRICE}&filter_interior=&filter_surface=`,
        filters: {
    ...
    valkvastgoed: {
        url: `http://www.valkvastgoed.com/aanbod/?city=${exports.CITY}&district=&min-price=${exports.MIN_PRICE}&interior=&bedrooms=&available_at=`,
        filters: {
            item: "li.rent",
            title: ".info h3 a",
            address: ".info h3 a",
    ...
    houseSelect: {
        url: `https://www.hsmakelaars.nl/woningaanbod/huur/land-nederland/gemeente-${exports.CITY.toLowerCase()}?locationofinterest=${exports.CITY}&pricerange.minprice=${exports.MIN_PRICE}`,
        filters: {
    ...
    // },
    vhpn: {
        url: `http://www.vhpn.nl/index.php?action=search&p=search&street=&city=${exports.CITY.toLowerCase()}&house_type=&bedrooms=&min-price=${exports.MIN_PRICE}&interior=`,
        filters: {
    ...
    // },
    indestad: {
        url: `https://www.indestad.nl/huurwoningen/?wpp_search%5Bpagination%5D=on&wpp_search%5Bper_page%5D=10&wpp_search%5Bstrict_search%5D=false&wpp_search%5Bproperty_type%5D=direct_aanbod&wpp_search%5Bprice%5D%5Bmin%5D=${exports.MIN_PRICE}&wpp_search%5Barea%5D%5Bmin%5D=&wpp_search%5Barea%5D%5Bmax%5D=&wpp_search%5Bplaats%5D%5B0%5D=${exports.CITY}`,
        filters: {
    ...
    kolpa: {
        url: `http://www.kolpa.nl/nl/aanbod?plaats=${exports.CITY}&koophuur=huur&prijs_min=${exports.MIN_PRICE}&type=priv`,
        filters: {
            item: ".object-item",
    ...
    vbo: {
        url: `https://www.vbo.nl/huurwoningen/${exports.CITY.toLowerCase()}/${exports.MIN_PRICE}+.html?p=1&l=20`,
        filters: {
    ...
    // },
    immobilia: {
        url: `https://www.immobilia.nl/nl/aanbod?koophuur=huur&plaats=${exports.CITY}&order=datum&direction=asc`,
        filters: {
    ...
    lankhuijzen: {
        url: `https://www.lankhuijzen.nl/aanbod/woningaanbod/${exports.CITY.toUpperCase()}/${exports.MIN_PRICE}+/huur/aantal-20/`,
        filters: {
            item: ".aanbodEntry",
    ...
    riva: {
        url: `https://www.rivarentals.nl/huurwoningen-${exports.CITY.toLowerCase()}/?action=search&city=${exports.CITY.toLowerCase()}&min-price=${exports.MIN_PRICE}`,
        filters: {
    ...
    pararius: {
        url: `https://www.pararius.com/apartments/${exports.CITY.toLowerCase()}/area-${exports.CITY.toLowerCase()}-centrum/${exports.MIN_PRICE}-5000`,
        filters: {
    ...
    athomevastgoed: {
        url: `https://www.athomevastgoed.nl/woningaanbod?order=published_at_desc&location=${exports.CITY}&_labels%5Blocation%5D=&category=all&furnishing=all&number_of_bedrooms=&ray=0&min_price=${exports.MIN_PRICE}&area=`,
    },
    // korrektwonen: {
    ...
    // },
    rotsvast: {
        url: `https://www.rotsvast.nl/en/property-listings/?type=2&city=${exports.CITY}&minimumPrice[2]=${exports.MIN_PRICE}`,
        filters: {
    ...
    maxProperty: {
        url: `https://www.maxpropertyrental.com/woningaanbod/huur/land-nederland/gemeente-${exports.CITY.toLowerCase()}?locationofinterest=${exports.CITY}&pricerange.minprice=${exports.MIN_PRICE}`,
        filters: {
